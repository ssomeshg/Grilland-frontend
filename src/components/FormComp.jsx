...
function FormComp({setFormModal}) {
    ...
    <div className="">
      ...
      <div className="fixed bg-white shadow-xl rounded-md p-4 border border-yellow-400  min-w-96 m-auto z-30 left-[50%] -translate-x-[50%] top-[50%] -translate-y-[50%]">
        ...
        <form action="" method="post">
          ...
          <div className="mb-5">
            <label htmlFor="" className="text-sm font-medium mb-2">Category Name</label>
            <input type="text" placeholder="category Name" className="w-full border-yellow-300 border rounded-md p-3 text-sm focus:outline-none focus:border focus:border-yellow-500" />
          </div>
